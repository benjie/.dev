...
stage: "0"
champion: yaacovCR
prUrl: https://github.com/graphql/graphql-wg/discussions/944
events:
...
- **PR**: [New Intersection Type](https://github.com/graphql/graphql-wg/discussions/944)
- **Related**: [#939](/rfcs/939) (allow unions to declare implementation of interfaces), [ExpandingSubtyping](/rfcs/ExpandingSubtyping) (Expanding Subtyping (for output types))
