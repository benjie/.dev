...
- **Related**: [#586](/rfcs/586) (Input Objects accepting exactly @oneField), [#825](/rfcs/825) (OneOf Input Objects), [InputUnion](/rfcs/InputUnion) (GraphQL Input Union), [SchemaCoordinates](/rfcs/SchemaCoordinates) (Schema Coordinates), [wg#1071](/rfcs/wg1071) (Struct type)
