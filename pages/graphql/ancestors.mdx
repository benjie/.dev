...
considering the need for [graph traversal](./traversal.mdx) it becomes apparent
why this isn't a supported behaviour of GraphQL. In particular,
[normalized stores](./normalized.mdx) rely on the execution behaviour outlined
in the GraphQL specification, and to change this fundamental behaviour could
cause applications using normalized stores to produce subtle issues and a lot of
confusion and frustration.

## Breaks normalized stores

If you implement the described change, you might get a result from the request
above such as:
