...
- [graphql-request](https://github.com/jasonkuhrt/graffle/issues/269) (or
  anything else that uses a replaceable `fetch()` implementation)
...
documents you already have and issue them with their own carefully crafted inputs.
