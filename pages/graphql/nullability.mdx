...
- Caliban supports `@semanticNonNull`: https://ghostdogpr.github.io/caliban/docs/schema.html#semanticnonnull-support
- Strawberry is [working on support for semantic nullability](https://github.com/strawberry-graphql/strawberry/pull/3722)
- async-graphql is [working on support for @semanticNonNull](https://github.com/async-graphql/async-graphql/issues/1605)
- gqlgen is has [an issue tracking this desire](https://github.com/99designs/gqlgen/issues/3396)
